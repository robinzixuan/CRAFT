...
MODEL_PATH=deepseek-ai/DeepSeek-R1-Distill-Llama-8B # replace it with your local file path
...
$PYTHON_BIN -m verl.trainer.main \
    config=examples/configs/config_deepseek_r1_distill_llama_8b.yaml \
    ...
    trainer.experiment_name=llama_think_safety
